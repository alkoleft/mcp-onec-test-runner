...
sealed class CommandBuilder {
    ...
    protected fun <T : IbcmdCommand> configureCommand(
        command: T,
        configure: (T.() -> Unit)?,
    ) {
...
class InfobaseCommandBuilder : CommandBuilder() {
     ...
     */
    fun create(configure: InfobaseCreateCommand.() -> Unit = { }) = configureCommand(InfobaseCreateCommand(), configure)
     ...
     */
    fun clear(configure: InfobaseClearCommand.() -> Unit = { }) = configureCommand(InfobaseClearCommand(), configure)

    /**
     * Создает команду репликации ИБ
     */
    fun replicate(configure: InfobaseReplicateCommand.() -> Unit = { }) = configureCommand(InfobaseReplicateCommand(), configure)
}
...
class ConfigCommandBuilder : CommandBuilder() {
     ...
     */
    fun check(configure: ConfigCheckCommand.() -> Unit = { }) = configureCommand(ConfigCheckCommand(), configure)

    /**
     * Создает команду применения конфигурации
     */
    fun apply(configure: ConfigApplyCommand.() -> Unit = { }) = configureCommand(ConfigApplyCommand(), configure)

    /**
     * Создает команду сброса конфигурации
     */
    fun reset(configure: ConfigResetCommand.() -> Unit = { }) = configureCommand(ConfigResetCommand(), configure)
     ...
     */
    fun sign(configure: ConfigSignCommand.() -> Unit = {}) = configureCommand(ConfigSignCommand(), configure)
     ...
     */
    fun repair(configure: ConfigRepairCommand.() -> Unit = {}) = configureCommand(ConfigRepairCommand(), configure)

    /**
     * Снимает конфигурацию с поддержки.
     */
    fun supportDisable(configure: ConfigSupportDisableCommand.() -> Unit = {}) = configureCommand(ConfigSupportDisableCommand(), configure)

    /**
     * Получает идентификатор поколения конфигурации.
     */
    fun generationId(configure: ConfigGenerationIdCommand.() -> Unit = {}) = configureCommand(ConfigGenerationIdCommand(), configure)
...
class ExtensionCommandBuilder : CommandBuilder() {
     ...
     */
    fun list(configure: ExtensionListCommand.() -> Unit = { }) = configureCommand(ExtensionListCommand(), configure)
     ...
     */
    fun delete(configure: ExtensionDeleteCommand.() -> Unit = { }) = configureCommand(ExtensionDeleteCommand(), configure)
}
