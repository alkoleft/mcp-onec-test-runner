...
class PlainTextParserStrategy : ReportParserStrategy {
    ...
    override fun canHandle(format: ReportFormat): Boolean = format == ReportFormat.PLAIN_TEXT

    override fun getSupportedFormats(): Set<ReportFormat> = setOf(ReportFormat.PLAIN_TEXT)
     ...
     */
    private fun extractTestName(line: String): String = line.substringAfterLast(" ").substringBefore(":").trim()
