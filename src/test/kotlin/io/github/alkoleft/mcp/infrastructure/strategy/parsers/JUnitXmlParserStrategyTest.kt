...
class JUnitXmlParserStrategyTest {
    ...
    @Test
    fun `should parse valid jUnit XML report`() =
        runBlocking {
            // Given
            val xmlContent =
                """
    ...
    @Test
    fun `should handle multiple test suites`() =
        runBlocking {
            // Given
            val xmlContent =
                """
    ...
    @Test
    fun `should handle skipped tests`() =
        runBlocking {
            // Given
            val xmlContent =
                """
    ...
    @Test
    fun `should detect jUnit XML format`() =
        runBlocking {
            // Given
            val xmlContent =
                """
